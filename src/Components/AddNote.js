...
const [note, setNote] = useState({title: "", description: "", tag: "default", location:""})
  const handleClick=(e)=>{
   e.preventDefault();
    //addNote(note.title,note.description,note.tag);
     addNote({title: note.title, description :  note.description, tag:  note.tag, location: note.location});
  }
...
<TopBanner><h1>Add an Event</h1></TopBanner>


    <form className name ="my-3">


      <div className="my-3">
        <label htmlFor="title"  className="form-label">Title</label>
        <input type="text" className="form-control" id="title" name ="title" aria-describedby="emailHelp" placeholder="Your event title"
             onChange={onChange}
        />
      ...
      <div className="mb-3">
        ...
        <input type="text" className="form-control" id="description" name="description" placeholder="Event  Time and Event Date  "    onChange={onChange}/>
        </div>
        <div className="mb-3">
        <label htmlFor="location" className="form-label">Location</label>
        <input type="text" className="form-control" id="location" name="location"  placeholder="Your event Location " onChange={onChange}/>
        </div>
...
//   const handleClick = (e) => {
//     e.preventDefault();
//     addEvent(note.title, note.description, note.tag);
//   }
...
//           <input type="text" className="form-control" id="description" name="description" onChane={onChange} />
//         </div>
//         <div className="mb-3 form-check">
//           <input type="checkbox" className="form-check-input" id="exampleCheck1" />
