...
const NewsFeed = ({ today }) => {
  ...
  useEffect(() => {
    if (localStorage.getItem("date") === format(today, "yyyy-MM-dd")) {
      ...
      fetch(
        /*https://google-news.p.rapidapi.com/v1/geo_headlines?lang=en&country=CA&geo=Montreal*/"https://google-news.p.rapidapi.com/v1/top_headlines?lang=en&country=US",
        {
          method: "GET",
          headers: {
            "x-rapidapi-key": '170ca97b17msh49cf36769234ae2p183b3ejsn1718eafb5166',
